    ...
    <main className="min-h-screen bg-neutral-100 px-4 py-6 print:min-h-0 print:bg-white print:px-0 print:py-0">
      <div className="mx-auto w-full max-w-[960px] space-y-3 print:h-[148mm] print:max-w-none print:space-y-0">
        ...
        <section className="overflow-hidden rounded-3xl border border-border bg-white shadow-sm print:rounded-none print:border-0 print:shadow-none">
          <div className="border-b border-border px-6 py-5 print:px-4 print:py-2">
            <div className="flex flex-wrap items-start justify-between gap-4 print:gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted-foreground print:text-[9px]">
                  Recibo de retirada
                </p>
                <h1 className="mt-1.5 text-2xl font-bold tracking-tight text-foreground print:mt-0.5 print:text-[20px]">
          ...
          <div className="grid gap-5 px-6 py-5 md:grid-cols-[1.1fr_0.9fr] print:gap-3 print:px-4 print:py-2">
            <div className="space-y-4 print:space-y-2">
              <div>
                <h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground print:text-[9px]">
                  Cliente
                </h2>
              ...
              <div>
                ...
                <dl className="mt-2 space-y-2 text-sm print:mt-1 print:space-y-1 print:text-[10px]">
              ...
              {(cashEntry.notes || serviceOrder.pickup_notes) && (
                <div>
                  ...
                  <p className="mt-2 whitespace-pre-wrap text-sm leading-snug text-foreground print:mt-1 print:text-[10px]">
                    {cashEntry.notes ?? serviceOrder.pickup_notes}
                  </p>
                </div>
              )}
            ...
            <div className="rounded-2xl border border-border bg-muted/20 p-5 print:rounded-lg print:p-3">
              <h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground print:text-[9px]">
                Fechamento financeiro
              </h2>

              <div className="mt-4 space-y-3 print:mt-2 print:space-y-1.5">
                <div className="flex items-center justify-between gap-4 text-sm print:text-[10px]">
